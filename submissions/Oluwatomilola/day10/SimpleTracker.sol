...
// I'll expand this later to include things like fitness goals, achievements, or social features
...
contract SimpleFitnessTracker {
    ...
    function logWorkout(string memory _activityType, uint256 _duration, uint256 _distance) public onlyRegistered {
        ...
        //Add to user's workout history
         ...
         emit WorkoutLogged(msg.sender, activityType, duration, distance, block.timeStamp);
